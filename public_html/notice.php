...
<?php
  ...
  $sql = 'select * from notice order by NO desc' . $sqlLimit; //원하는 개수만큼 가져온다. (0번째부터 20번째까지
  $result = $db->query($sql);
?>
                    ...
                    <table class="table table-striped table-bordered text-center" border=0 width=100% height=100%>
                      ...
                      <tbody>
                        ...
                        <tr style="text-align:center">
                          ...
                          <td vertical-align="middle" class="header"><a href="./noticeview.php?no=<?php echo $row["NO"]?>"><?php echo $row["HEADER"] ?></a></td>
